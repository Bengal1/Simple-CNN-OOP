...
<img src="https://github.com/Bengal1/Simple-CNN-Guide/assets/34989887/949de912-716e-438c-9a41-c864ba930128" align="right" height="200"/>
...
<img src="https://github.com/user-attachments/assets/fcd91530-7bc2-4610-897a-3ff43bce3335" align="right" height="200"/>
...
$$
\mathrm{Softmax}(\mathbf{z}) \mathrm{Softmax}(z)_i = \frac{e^{z_i}}{\sum_{j=1}^{K} e^{z_j}} \quad \text{for } i = 1, 2, \ldots, K \quad ; \quad \mathbf{z} \in \mathbb{R}^{K}
$$
