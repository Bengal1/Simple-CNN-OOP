...
[**Convolution2d**](https://github.com/Bengal1/SimpleCNN-OOP/blob/master/SimpleCNN/Layers/Convolution2D.h) - Applies a 2D convolution over an input signal composed of singular or several data inputs.

[**MaxPooling**](https://github.com/Bengal1/SimpleCNN-OOP/blob/master/SimpleCNN/Layers/MaxPooling.h) - Applies a 2D max pooling over an input signal composed of singular or several data inputs.

[**FullyConnected**](https://github.com/Bengal1/SimpleCNN-OOP/blob/master/SimpleCNN/Layers/FullyConnected.h) - Applies a linear transformation to the layer's input, *y=xA<sup>T</sup>+b*. In that case the input is 2-dimentions, *(N,H)* with the same notations above.
