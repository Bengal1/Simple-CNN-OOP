...
Adam::Adam(int numParams,
	double maxGradNorm, double weightDecay, double learningRate,
...
void Adam::updateStep(Eigen::VectorXd& parameters,
...
void Adam::updateStep(Eigen::MatrixXd& parameters,
